...
### Notes
- The 'd' for debug option, will, copy back all the backed up files to scripts and delete the cleaned files, its used for, testing and development, do not use it.

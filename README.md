...
- Now working on concise two word naming of functions, ie "# Function Select Theme" from "def function_select_theme()", for, python and powershell and mql5, and for maps in just, python and powershell. such things are not possible in batch. And that will be all the ideas implemented, that I have for now.

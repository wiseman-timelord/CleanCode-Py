...
- requires rules making for each file format, to be entered into the new 4 functions.
...
- Script now has 4 additional functions, 1 for each of the file formats supported.
